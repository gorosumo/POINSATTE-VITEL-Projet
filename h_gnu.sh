...
set output "h_png" #On indique que le fichier de sortie doit s'appeler t1_png.
set title "Carte d'altitude" #On définie "Température t1" comme titre du graphique.
